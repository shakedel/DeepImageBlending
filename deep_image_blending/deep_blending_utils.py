...
def compute_gt_gradient_alt(source_img_tensor, target_img_tensor, mask, gpu_id):
    # compute source image gradient
    ...
    # foreground gradient
    red_foreground_gradient = red_source_gradient_tensor * mask
    green_foreground_gradient = green_source_gradient_tensor * mask
    blue_foreground_gradient = blue_source_gradient_tenosr * mask

    # background gradient
    red_background_gradient = red_target_gradient_tensor * (mask - 1) * (-1)
    green_background_gradient = green_target_gradient_tensor * (mask - 1) * (-1)
    blue_background_gradient = blue_target_gradient_tenosr * (mask - 1) * (-1)
